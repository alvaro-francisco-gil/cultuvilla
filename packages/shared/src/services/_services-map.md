...
| [municipalityService](municipalityService.ts) | `municipalities/`, `municipalities/{id}/barrios/`, `municipalities/{id}/places/` | App-wide INE municipalities + nested barrios and places (cemeteries, churches, …, discriminated by `kind`). CRUD. | `getMunicipalities`, `createMunicipality`, `getBarrio`, `getBarrios`, `createBarrio`, `getPlace`, `getPlaces`, `createPlace`, plus updates/deletes |
| [newsService](newsService.ts) | `news/`, `newsComments/`, `newsReactions/`, `newsReports/` (all top-level, `municipalityId` field) | Village news feed: create/get/list/update posts, react, comment, report comments, fetch home + other-villages feeds. Cross-user moderation lives in Cloud Functions. | `createNewsPost`, `getNewsPost`, `getNewsPostsByMunicipality`, `updateNewsPost`, `deleteNewsPost` (callable, cascades comments/reactions), `reactToPost`, `removeReaction`, `getMyReaction`, `addComment`, `getComments`, `deleteOwnComment`, `reportComment`, `getHomeFeed`, `getAllVillagesFeed`, `getOtherVillagesFeed`, `getNewsPostsByOrganizer`, `getApprovedNewsPostsByOrganizer` |
