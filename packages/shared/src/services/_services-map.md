...
| [newsService](newsService.ts) | `news/`, `newsComments/`, `newsReactions/`, `newsReports/` (all top-level, `municipalityId` field) | Village news feed: create/get/list/update posts, react, comment, report comments, fetch home + other-villages feeds. Cross-user moderation lives in Cloud Functions. | `createNewsPost`, `getNewsPost`, `getNewsPostsByMunicipality`, `updateNewsPost`, `reactToPost`, `removeReaction`, `getMyReaction`, `addComment`, `getComments`, `deleteOwnComment`, `reportComment`, `getHomeFeed`, `getAllVillagesFeed`, `getOtherVillagesFeed`, `getNewsPostsByOrganizer`, `getApprovedNewsPostsByOrganizer` |
