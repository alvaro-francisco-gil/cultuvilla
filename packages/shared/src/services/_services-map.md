...
| [organizationService](organizationService.ts) | `organizations/` (top-level, `municipalityId` field) | Org CRUD + request/approve/reject lifecycle (ayuntamiento, peña, asociación). Cross-village pending list for super-admin. | `getOrganization`, `getPendingOrganizations`, `getOrganizationsByVillage`, `requestOrganization`, `approveOrganization`, `rejectOrganization`, `updateOrganization`, `deleteOrganization` |
