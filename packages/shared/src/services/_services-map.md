...
| [organizationJoinRequestService](organizationJoinRequestService.ts) | `organizationJoinRequests/` | Requests for a user to join an organization. Users submit + read own; org admins list pending for their orgs; superadmin firehose; mutations via Cloud Function. | `requestJoinOrganization`, `respondToJoinRequest`, `getAllPendingJoinRequests`, `getPendingJoinRequestsForOrgs`, `getMyJoinRequests` |
