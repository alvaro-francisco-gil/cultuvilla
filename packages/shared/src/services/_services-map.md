...
| [orgMemberService](orgMemberService.ts) | `organizations/{orgId}/members/` | Add/remove/check org membership; role-aware add and role mutation; admin-id lookup. | `getOrgMembers`, `getOrgMemberCount`, `addOrgMember(role?)`, `setOrgMemberRole`, `getOrgAdminIds`, `removeOrgMember`, `isOrgMember`, `getOrgMembershipsByUserInMunicipality` |
